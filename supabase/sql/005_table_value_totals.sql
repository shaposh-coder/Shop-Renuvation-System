-- Add filtered total_value to paginated Cash Records and Expenses RPC responses.
-- The total is calculated before pagination, so it represents all rows matching the current filters.
