...
export default function DashboardPage() {
  ...
  const currentMonthDefaults = useMemo(() => {
    ...
    return { from: toInput(firstDay), to: toInput(now) }
  }, [])
              ...
              <div className="space-y-3">
                {currentUserRole === 'Admin' ? (
                  <div>
                    ...
                    />
                    <datalist id="dashboard-filter-users">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <p className="mt-2 text-2xl font-bold text-gray-900">
            {isLoading ? 'Loading...' : formatCurrency(summary?.net_cash_in_hand ?? 0)}
          </p>
          <p className="mt-1 text-xs text-gray-500">Approved Cash - Approved Expenses</p>
          <div className="mt-4 space-y-2 text-sm">
            ...
            <div className="flex items-center justify-between border-t pt-2">
              ...
              <span className="font-bold text-gray-900">{formatCurrency(summary?.net_cash_in_hand ?? 0)}</span>
            </div>
          </div>
        </div>
